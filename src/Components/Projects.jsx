...
export default function Projects() {
    ...
    const projectData = [
        ...
        { id: "3", name: "Mailchimp - clone", img: "mailchimp.jpeg", gh:"https://github.com/raj-savsani/mailchimp_clone", url:"https://mailchimpclonee.herokuapp.com/", desc: "Mailchimp is an American marketing automation platform and email marketing service for managing mailing lists and creating email marketing campaigns", stack:"HTML , CSS, JavaScript, MongoDB, Express"},
